...
const Footer = () => {
    return (
        <div>
            <footer className="text-center lg:text-left bg-gray-100 text-gray-600 mt-10">
                <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                    <div className="mr-12 hidden lg:block">
                        <span>Follow Us on our Social Media:</span>
                    </div>
                    <div className="flex justify-center">
                        <a href="https://www.facebook.com/IamRaihan" className="mr-6 text-gray-600">
                        ...
                        <a href="https://twitter.com/IamRaihanAli" className="mr-6 text-gray-600">
                        ...
                        <a href="https://www.instagram.com/imraihanali" className="mr-6 text-gray-600">
                        ...
                        <a href="https://www.linkedin.com/in/IamRaihanAli" className="mr-6 text-gray-600">
                        ...
                        <a href="https://github.com/iamraihan" className="text-gray-600">
                    ...
                    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="">
                            <h6 className="uppercase font-semibold mb-4 flex items-center justify-center md:justify-start">
                                <FaTencentWeibo className='text-4xl'></FaTencentWeibo>
                            ...
                            <p>
                                Here we manage all kind of grocery products.
                            </p>
                        </div>
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <Link to='/' className="text-gray-600">Fruits</Link>
                            </p>
                            <p className="mb-4">
                                <Link to='/' className="text-gray-600">Meat</Link>
                            </p>
                            <p className="mb-4">
                                <Link to='/' className="text-gray-600">Sea Food</Link>
                            </p>
                            <p>
                                <Link to='/' className="text-gray-600">Others</Link>
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                            ...
                            <p>
                                <Link to='/manage-inventory' className="text-gray-600">Products</Link>
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
